            ...
            {!isVerified ? (
              <div className="mt-4 w-full space-y-3">
                ...
                <button
                  ...
                  className="w-full py-3 bg-linear-to-r from-blue-500 to-indigo-600 text-white rounded-xl"
                >
                ...
                <button
                  ...
                  className="w-full py-3 bg-linear-to-r from-blue-400 to-indigo-500 text-white rounded-xl"
                >
                  Cancel
                </button>
